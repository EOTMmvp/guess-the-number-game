...
print("He seleccionado un número entre 1 y 100 !Adivina cual es !")

numero_secreto = random.randint(1, 100)
intentos_maximos = int(input("cuantos intentos quieres para adivinar: "))
adivinanza = 0
...
input("preiona Enter para salir")
